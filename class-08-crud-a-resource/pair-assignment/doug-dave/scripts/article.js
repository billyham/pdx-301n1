(function(module) {
  ...
  Article.createTable = function(callback) {
    webDB.execute(
      'CREATE TABLE IF NOT EXISTS articles (id INTEGER PRIMARY KEY, title VARCHAR(100) NOT NULL, category VARCHAR(100) NOT NULL, author VARCHAR(100)NOT NULL, authorUrl VARCHAR(255)NOT NULL, publishedOn DATE NOT NULL, body TEXT NOT NULL);',
      function(result) {
  ...
  Article.fetchAll = function(next) {
    webDB.execute('SELECT * FROM articles ORDER BY title', function(rows) {
      if (rows.length) {
